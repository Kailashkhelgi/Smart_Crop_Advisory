...
// Navigation callback for handling unauthenticated state
...
// Attach Authorization header from AsyncStorage on every request
...
export const imageApi = {
  analyze: (file: { uri: string; name: string; type: string }) => {
